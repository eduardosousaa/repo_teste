...
export default function Page() {
   ...
   function actionButtons(id){
    return <div style={{display:"flex",gap:"2%",flexWrap:"wrap",
            ...
            <div className={styles.balloon_div}>
               <Button className={styles.button} onClick={() => {router.push(`/admin/configuracoes/documentos/${id}`)}}><BiInfoCircle/></Button>
            ...
            { checkPermission("Documentation_Read") && <>
             <div className={styles.balloon_div}>
               <Button className={styles.button} onClick={() => {router.push(`/admin/configuracoes/documentos/${id}/edit`)}}><BsPencilSquare/></Button>
               <div className={styles.balloon_aviso_div}>
                 <div className={styles.balloon_aviso_border}>
                   <div className={styles.balloon_aviso_text}>
                      Editar
   ...
   function getDocuments(data){
      ...
      fetch(Constantes.urlBackDocuments + "documents-group?" + new URLSearchParams(query), {
                method: "GET",
                headers: {
  ...
  function deleteDocument(){
         fetch(Constantes.urlBackDocuments + `documents-group/${documentId}`, {method: "DELETE",
             headers: {
             ...
             .then((status) => {
                  switch(status){
                      ...
                      break;
                      case 404:
                        showAlert("danger","Error ao Apagar Documento");
                      break;   
                  }
                 getDocuments();
                 setOpenModal(false);
   ...
   return (<>
        ...
        <CardHeader className={styles.header}>
         <h1 className={styles.header_h1}>Tipos de Documentos</h1>
        { checkPermission("Documentation_Read") && 
         <Button className={styles.header_button}
                 onClick={() => { router.push("/admin/configuracoes/documentos/create");}}>
             Cadastrar <FaPlus />
          </Button>}
        </CardHeader>
        ...
        <ModalStyle  open={openModal} title="Remover Tipo de Documento" onClick={() => {deleteDocument()}} toggle={() => setOpenModal(!openModal)}>

...
export default function Edit() {
  ...
  function getPeriodicMaintenance(id){
        ...
        .then(({ status, body}) => {
           ...
           switch(status){
               case 200:
                ...
                setAlertaInputs(Array(body.patrimonyAlerts.length).fill({phone:false,email:false}));
               break;
               case 400:
   ...
   function submit(data){
      ...
      fetch(Constantes.urlBackAdmin + `periodic_maintenance/${params.id}`, {
            method: "PUT",
            headers: {
   ...
   useEffect(() => {
      getPeriodicMaintenance(params.id);
   },[params])
            ...
            <UncontrolledAccordion defaultOpen={["configuracao"]} stayOpen style={{flex:"1"}}>
               <AccordionItem>
                  ...
                  <AccordionBody accordionId="configuracao" style={{padding:"15px"}}>
                    {/* Ideia --> <FormTipoDocumento data={data} submitData={submit} apiErrors={errors}/> */}

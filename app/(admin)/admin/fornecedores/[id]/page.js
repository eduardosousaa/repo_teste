   ...
   return (<>
        ...
        <CardHeader className={styles.header} style={{justifyContent:"flex-start", alignItems: "center"}}>
           <IoArrowBackCircleSharp style={{width:"45px",height:"70px",color:"#009E8B",cursor:"pointer"}}
                                   onClick={() => {router.back()}}/>
           <h1 className={styles.header_h1}>Dados do Fornecedor</h1>
        </CardHeader>
        ...
        <CardBody style={{width:"90%"}}>
         ...
         {data.company && <>
         <div style={{fontSize: "1.25rem", marginBottom:"20px"}}>Dados da Empresa</div>
         <Card style={{width:"80%",padding:"15px"}}>
           <Row className="d-flex mt-3">
              <Col sm="12">    
           ...
           { (data.company?.archivedCnpj != null || data.company?.archivedSocialContract != null) && 
                    <div style={{fontSize: "1.25rem",marginTop:"10px",
                                 marginBottom:"20px",borderBottom: "1px solid #727272"}}>Documentos da Empresa</div>}
         
          { data.company?.archivedCnpj != null  && 
               <div>CNPJ: <a style={{color:"#1FCEC9"}} href={Constantes.urlImages + data.company?.archivedCnpj} target="_blank" rel="noreferrer">
                  cnpj.pdf</a></div>} 
          
          { data.company?.archivedSocialContract != null && 
               <div>Contrato Social: <a style={{color:"#1FCEC9"}} href={Constantes.urlImages + data.company?.archivedSocialContract} target="_blank" rel="noreferrer">
                  contrato_social.pdf</a></div>} 
         </Card>     
         </>}
         ...
         {data.accountBanks?.length > 0 && <>
           ...
           {data.categories && <>
           <div style={{fontSize: "1.25rem",marginTop:"10px",marginBottom:"20px"}}>Categorias</div>
             ...
             <Card key={index} style={{width:"80%",padding:"15px"}}>
               <Row className="d-flex mt-3">
                 <Col sm="12">    
                   ...
                   <Label style={{height:"25px",fontSize:"16px"}}>{category.name}</Label> 
                 </Col>
               </Row>
             </Card>
           )} 

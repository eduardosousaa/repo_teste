...
import { FilingLotCdaFilterData } from "@/interfaces/FilingLot";

export default function FilingLotCdaFilter({
	onFilterChange,
	onClear,
}: {
	onFilterChange: (filters: FilingLotCdaFilterData) => void;
	onClear?: () => void;
}) {
	const [filters, setFilters] = useState<FilingLotCdaFilterData>({
		origin: "",
		emissionDate: "",
		cnpjStatus: "",
		tribute: "",
	...
	const handleInputChange = (
		name: keyof FilingLotCdaFilterData,
		value: string | number
	) => {
	...
	const handleClearFilters = () => {
		const cleared: FilingLotCdaFilterData = {
			origin: "",
			emissionDate: "",
			cnpjStatus: "",
			tribute: "",
